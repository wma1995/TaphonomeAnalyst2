...
| Proportion of taphonomic preservational grade of species analysis **(Module Ⅲ)**               |                                                                                                                                                                                            | TGotus<br>TGplots          | √                | √                |
| Taphonomic environment analysis **(Module Ⅳ)**                                                 | Including the creation of Veen diagrams that compare the diversity found across sedimentary environments or outcrops.                                                                      | clusterenv<br>divvenn      | √                | √                |
